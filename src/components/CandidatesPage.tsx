    ...
    <li className="relative group" data-info-row>
      <div onClick={onTogglePin}
        ...
        <div className="flex items-center gap-1.5 flex-wrap pr-5 mb-1.5" onClick={e => e.stopPropagation()}>
          {/* resolveCvUrl, never the raw stored value — and never the Office viewer,
              which renders an empty frame it cannot be talked out of. Yariv 2026-08-26: "קורות חיים של
          ...
          <FileChip label="CV" url={resolveCvUrl(c.cvUrl)} fileRef={c.cvUrl} />
          ...
          <FileChip label="טופס" url={resolveCvUrl(c.applicationUrl)} fileRef={c.applicationUrl}
